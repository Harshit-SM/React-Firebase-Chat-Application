    ...
    <div className={`ls ${chatVisible ? "hidden" : ""}`}>
      <div className="ls-top">
        <div className="ls-nav">
          <div className="chat-logo"><img className="logo" src="/src/assets/chat-logo.png" alt="logo" /> <span>Samvaad</span></div>
          <div className="menu">
      ...
      <div className="ls-list">
        {showSearch && user ? (
          ...
          chatData.map((item, index) => (
            <div onClick={() => setChat(item)} key={index} className={`friends ${item.messageSeen && item.messageId ? "" : "border" }`}>
